    ...
    <section id="banner" className="relative">
      ...
      >
        <div className="max-w-[544px] flex-col items-start justify-center self-center pt-12 max-lg:flex sm:pt-20 md:pt-0">
          ...
          >
            <span className="text-primary cursor">FULL STACK</span>
            <br /> <span className="cursor lg:ml-3">DEVELOPER</span>
          </h1>
          <ShinyText
            className="slide-up-and-fade cursor text-lg md:text-xl"
            text="
            Hi! I'm Vinay Joshi, a Full-Stack Developer and Computer Science graduate. I enjoy building scalable, user-centric web applications and solving real-world problems through clean, efficient code.
          "
          />
        </div>
