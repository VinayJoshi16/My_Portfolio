...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const host = headersList.get("host") || "vinayjoshi.dev";
  ...
  return {
    title: {
      template: "VINAY | %s",
      default: "VINAY | Full-Stack Developer",
    },
    description:
      "Full-Stack Developer building modern, responsive, and scalable web applications. Personal portfolio of Vinay Joshi.",
    ...
    openGraph: {
      ...
      siteName: "VINAY",
      images: [
        { url: "/og.png", width: 1200, height: 630, alt: "Vinay Joshi Full-Stack Developer" },
      ],
      type: "website",
    },
    twitter: {
